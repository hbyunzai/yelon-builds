...
function removeThird() {
    return (tree, context) => {
        ...
        (0, utils_1.logStart)(context, `Remove redundant dependencies: ngx-countdown, ng-yunzai-codelyzer, nz-tslint-rules`);
    };
}
...
function finished() {
    return (_tree, context) => {
        context.logger.warn(color_1.colors.yellow(`  ✓  After the upgrade is complete, you still need to execute \`ng lint --fix\` to fix the code format, Abort more detail please refer to upgrade guide https://ng.yunzainfo.com/docs/style-guide`));
        context.logger.info(color_1.colors.green(`  ✓  Congratulations, Abort more detail please refer to upgrade guide https://github.com/ng-yunzai`));
    };
}
function v12Rule(options) {
    return (tree, context) => __awaiter(this, void 0, void 0, function* () {
        (0, utils_1.logStart)(context, `Upgrade @yelon/* version number ${JSON.stringify(options)}`);
