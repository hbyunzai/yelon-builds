...
function removeIE() {
    return (tree, context) => {
        ...
        if (pkg.scripts && !pkg.scripts['ie:start'])
            return;
        context.logger.warn(color_1.colors.yellow(`TIPS: Starting from NG-YUNZAI 13 will no longer support IE`));
    };
}
...
function finished() {
    return (_tree, context) => {
        ...
        context.logger.info(color_1.colors.green(`  ✓ Congratulations, Abort more detail please refer to upgrade guide https://github.com/hbyunzai/ng-yunzai/issues/2174`));
    };
}
function v13Rule() {
    return (tree, context) => __awaiter(this, void 0, void 0, function* () {
        (0, utils_1.logStart)(context, `Upgrade @yelon/* version number`);
