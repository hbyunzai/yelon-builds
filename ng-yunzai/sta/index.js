...
function finished() {
    return (_, context) => {
        context.logger.info(color_1.colors.green(`✓  Finished, refer to: https://ng.yunzainfo.com/cli/sta`));
    };
}
...
function default_1(options) {
    return (tree, context) => __awaiter(this, void 0, void 0, function* () {
        context.logger.info(color_1.colors.yellow(`The ng g ng-yunzai:sta is currently in testing status and may change before the major version of '13'`));
