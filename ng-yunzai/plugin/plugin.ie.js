...
function finished() {
    return (_, context) => {
        context.logger.info(colors.yellow(`  ⚠  If you encounter [No provider for YunzaiConfigService], please refer to https://github.com/hbyunzai/ng-yunzai/issues/1624#issuecomment-623071468`));
    };
}
