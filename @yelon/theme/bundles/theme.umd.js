...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var YunzaiI18nBaseService = /** @class */ (function () {
        ...
        Object.defineProperty(YunzaiI18nBaseService.prototype, "defaultLang", {
            get: function () {
        ...
        Object.defineProperty(YunzaiI18nBaseService.prototype, "currentLang", {
            get: function () {
        ...
        Object.defineProperty(YunzaiI18nBaseService.prototype, "data", {
            get: function () {
                return this._data;
            },
            enumerable: false,
         ...
         * }
         */
        YunzaiI18nBaseService.prototype.flatData = function (data, parentKey) {
            var e_1, _a;
            var res = {};
        ...
        YunzaiI18nBaseService.prototype.fanyi = function (path, params) {
    ...
    var YunzaiI18NServiceFake = /** @class */ (function (_super) {
        ...
        YunzaiI18NServiceFake.prototype.use = function (lang, data) {
            this._data = this.flatData(data, []);
            this._currentLang = lang;
            this._change$.next(lang);
        };
        YunzaiI18NServiceFake.prototype.getLangs = function () {
            return [];
        };
    ...
    MenuService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function MenuService_Factory() { return new MenuService(i0__namespace.ɵɵinject(YUNZAI_I18N_TOKEN, 8), i0__namespace.ɵɵinject(i2__namespace.ACLService, 8)); }, token: MenuService, providedIn: "root" });
    MenuService.decorators = [
        { type: i0.Injectable, args: [{ providedIn: 'root' },] }
    ];
    MenuService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [YUNZAI_I18N_TOKEN,] }] },
        { type: i2.ACLService, decorators: [{ type: i0.Optional }] }
    ]; };

    var YUNZAI_SETTING_KEYS = new i0.InjectionToken('YUNZAI_SETTING_KEYS');
    ...
    var RTL_YELON_COMPONENTS = ['loading', 'onboarding'];
    var LTR = 'ltr';
    var RTL = 'rtl';
    var RTLService = /** @class */ (function () {
        function RTLService(d, srv, nz, yelon, platform, doc) {
            this.d = d;
            this.srv = srv;
            this.nz = nz;
            this.yelon = yelon;
        ...
        RTLService.prototype.updateLibConfig = function () {
            ...
            RTL_YELON_COMPONENTS.forEach(function (name) {
                _this.yelon.set(name, { direction: _this.dir });
            });
        };
        return RTLService;
    }());
    ...
    var TitleService = /** @class */ (function () {
        ...
        TitleService.prototype.getByElement = function () {
            var el = (this.doc.querySelector('.yunzai-default__content-title h1') ||
    ...
    TitleService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function TitleService_Factory() { return new TitleService(i0__namespace.ɵɵinject(i0__namespace.INJECTOR), i0__namespace.ɵɵinject(i1__namespace$3.Title), i0__namespace.ɵɵinject(MenuService), i0__namespace.ɵɵinject(YUNZAI_I18N_TOKEN, 8), i0__namespace.ɵɵinject(i6__namespace.DOCUMENT)); }, token: TitleService, providedIn: "root" });
    ...
    var YELON_LOCALE = new i0.InjectionToken('yelon-locale');
    ...
    var YelonLocaleService = /** @class */ (function () {
        function YelonLocaleService(locale) {
            this._locale = zhCN;
            this.change$ = new rxjs.BehaviorSubject(this._locale);
            this.setLocale(locale || zhCN);
        }
        Object.defineProperty(YelonLocaleService.prototype, "change", {
            get: function () {
        ...
        YelonLocaleService.prototype.setLocale = function (locale) {
        ...
        Object.defineProperty(YelonLocaleService.prototype, "locale", {
            get: function () {
                return this._locale;
            },
            enumerable: false,
        ...
        YelonLocaleService.prototype.getData = function (path) {
            return (this._locale[path] || {});
        };
        return YelonLocaleService;
    }());
    YelonLocaleService.decorators = [
        { type: i0.Injectable }
    ];
    YelonLocaleService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [YELON_LOCALE,] }] }
    ]; };
    function YELON_LOCALE_SERVICE_PROVIDER_FACTORY(exist, locale) {
        return exist || new YelonLocaleService(locale);
    }
    var YELON_LOCALE_SERVICE_PROVIDER = {
        provide: YelonLocaleService,
        useFactory: YELON_LOCALE_SERVICE_PROVIDER_FACTORY,
        deps: [[new i0.Optional(), new i0.SkipSelf(), YelonLocaleService], YELON_LOCALE]
    };

    var ɵ0$1 = zhCN;
    var YelonLocaleModule = /** @class */ (function () {
        function YelonLocaleModule() {
        }
        return YelonLocaleModule;
    }());
    YelonLocaleModule.decorators = [
        { type: i0.NgModule, args: [{
                    providers: [{ provide: YELON_LOCALE, useValue: ɵ0$1 }, YELON_LOCALE_SERVICE_PROVIDER]
                },] }
    ];
    ...
    I18nPipe.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [YUNZAI_I18N_TOKEN,] }] }
    ]; };
    ...
    // #endregion
    var YunzaiThemeModule = /** @class */ (function () {
        function YunzaiThemeModule(iconSrv) {
            iconSrv.addIcon.apply(iconSrv, __spreadArray([], __read(ICONS)));
        }
        YunzaiThemeModule.forRoot = function () {
            return {
                ngModule: YunzaiThemeModule,
                providers: __spreadArray([], __read(HELPERS))
            };
        };
        YunzaiThemeModule.forChild = function () {
            return {
                ngModule: YunzaiThemeModule,
                providers: __spreadArray([], __read(HELPERS))
            };
        };
        return YunzaiThemeModule;
    }());
    YunzaiThemeModule.decorators = [
        { type: i0.NgModule, args: [{
                    ...
                    exports: __spreadArray(__spreadArray([], __read(PIPES)), [YelonLocaleModule])
                },] }
    ];
    YunzaiThemeModule.ctorParameters = function () { return [
        { type: icon.NzIconService }
    ]; };

    var VERSION = new i0.Version('12.0.16');
    ...
    exports.RTL_YELON_COMPONENTS = RTL_YELON_COMPONENTS;
    exports.ResponsiveService = ResponsiveService;
    exports.SettingsService = SettingsService;
    exports.TitleService = TitleService;
    exports.URLPipe = URLPipe;
    exports.VERSION = VERSION;
    exports.YELON_LOCALE = YELON_LOCALE;
    exports.YELON_LOCALE_SERVICE_PROVIDER = YELON_LOCALE_SERVICE_PROVIDER;
    exports.YELON_LOCALE_SERVICE_PROVIDER_FACTORY = YELON_LOCALE_SERVICE_PROVIDER_FACTORY;
    exports.YNPipe = YNPipe;
    exports.YUNZAI_I18N_TOKEN = YUNZAI_I18N_TOKEN;
    exports.YUNZAI_SETTING_KEYS = YUNZAI_SETTING_KEYS;
    exports.YelonLocaleModule = YelonLocaleModule;
    exports.YelonLocaleService = YelonLocaleService;
    exports.YunzaiI18NServiceFake = YunzaiI18NServiceFake;
    exports.YunzaiI18nBaseService = YunzaiI18nBaseService;
    exports.YunzaiThemeModule = YunzaiThemeModule;
