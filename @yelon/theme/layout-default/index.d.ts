...
import { TemplateRef, OnInit, QueryList, OnDestroy, EventEmitter, AfterViewInit } from '@angular/core';
import * as i8 from '@angular/router';
import { Event } from '@angular/router';
import * as _angular_cdk_bidi_module_d_IN1Vp56w from '@angular/cdk/bidi-module.d-IN1Vp56w';
import { SafeHtml } from '@angular/platform-browser';
import { MenuInner, Menu, App } from '@yelon/theme';
...
declare class LayoutDefaultComponent implements OnInit {
...
declare class LayoutDisplayService implements OnDestroy {
    private displayNav;
