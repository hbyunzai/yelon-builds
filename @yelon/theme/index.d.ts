...
import { ACLCanType } from '@yelon/acl';
...
import { YunzaiConfigService, YunzaiConfig } from '@yelon/util/config';
...
import * as _ant_design_icons_angular from '@ant-design/icons-angular';
...
declare const YUNZAI_SETTING_KEYS: InjectionToken<SettingsKeys>;
declare const YUNZAI_SETTING_DEFAULT: Provider;
...
declare const YUNZAI_I18N_TOKEN: InjectionToken<YunzaiI18NService>;
declare abstract class YunzaiI18nBaseService implements YunzaiI18NService {
    protected readonly cogSrv: YunzaiConfigService;
    private cog;
...
declare class YunzaiI18NServiceFake extends YunzaiI18nBaseService {
    use(lang: string, data: Record<string, unknown>): void;
    getLangs(): any[];
...
declare class YunzaiI18NGuardService {
    private readonly i18nSrv;
    private readonly cogSrv;
 ...
 * ```
 */
declare const yunzaiI18nCanActivate: CanActivateFn;
/**
 * Internationalization guard, automatically recognizes the language in Url and triggers the `YUNZAI_I18N_TOKEN.use` method
 *
 * 国际化守卫，自动识别Url中的语言，并触发 `YUNZAI_I18N_TOKEN.use` 方法
 ...
 * ```
 */
declare const yunzaiI18nCanActivateChild: CanActivateChildFn;
...
declare const YUNZAI_LANGS: Record<string, LangConfigData>;

interface YunzaiI18NType {
    code: string;
    text: string;
    abbr: string;
    icon?: string;
}
declare class YunzaiHttpI18NService extends YunzaiI18nBaseService implements OnDestroy {
    protected _defaultLang: string;
    private $destroy;
    private http;
    private settings;
...
declare const YELON_LOCALE: InjectionToken<FullLocaleData>;

declare class YelonLocaleService {
    private defLocale;
    private _locale;
    private change$;
    constructor();
...
declare function YELON_LOCALE_SERVICE_PROVIDER_FACTORY(exist: YelonLocaleService): YelonLocaleService;
declare const YELON_LOCALE_SERVICE_PROVIDER: Provider;

declare class YelonLocaleModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<YelonLocaleModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<YelonLocaleModule, never, never, never>;
    static ɵinj: i0.ɵɵInjectorDeclaration<YelonLocaleModule>;
}
...
declare class YunzaiThemeModule {
    constructor(iconSrv: NzIconService);
    static forRoot(): ModuleWithProviders<YunzaiThemeModule>;
    static forChild(): ModuleWithProviders<YunzaiThemeModule>;
    static ɵfac: i0.ɵɵFactoryDeclaration<YunzaiThemeModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<YunzaiThemeModule, never, [typeof i1.CommonModule, typeof i2.RouterModule, typeof i3.OverlayModule, typeof i4.NzI18nModule, typeof DatePipe, typeof KeysPipe, typeof YNPipe, typeof I18nPipe, typeof HTMLPipe, typeof URLPipe], [typeof DatePipe, typeof KeysPipe, typeof YNPipe, typeof I18nPipe, typeof HTMLPipe, typeof URLPipe, typeof YelonLocaleModule]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<YunzaiThemeModule>;
}

interface YunzaiProvideOptions {
    config?: YunzaiConfig;
    /**
...
declare function provideYunzai(options: YunzaiProvideOptions): EnvironmentProviders;
...
declare const ICONS: _ant_design_icons_angular.IconDefinition[];

declare const VERSION: Version;

export { BaseApi, BaseHeaders, BaseUrl, Body, CUSTOM_ERROR, DELETE, DatePipe, DrawerHelper, FORM, GET, HEAD, HTMLPipe, HTML_DIR, Headers, I18nPipe, ICONS, IGNORE_BASE_URL, JSONP, KeysPipe, LTR, MenuService, ModalHelper, OPTIONS, PATCH, POST, PUT, Path, Payload, PreloadOptionalModules, Query, RAW_BODY, REP_MAX, RTL, RTLService, RTL_DIRECTION, RTL_NZ_COMPONENTS, RTL_YELON_COMPONENTS, ResponsiveService, SPAN_MAX, SettingsService, TitleService, URLPipe, VERSION, YELON_LOCALE, YELON_LOCALE_SERVICE_PROVIDER, YELON_LOCALE_SERVICE_PROVIDER_FACTORY, YNPipe, YUNZAI_I18N_TOKEN, YUNZAI_LANGS, YUNZAI_SETTING_DEFAULT, YUNZAI_SETTING_KEYS, YelonLocaleModule, YelonLocaleService, YunzaiHttpI18NService, YunzaiI18NGuardService, YunzaiI18NServiceFake, YunzaiI18nBaseService, YunzaiThemeModule, _HttpClient, _default as ar_SA, _default$9 as el_GR, _default$e as en_US, _default$3 as es_ES, _default$4 as fr_FR, _default$7 as hr_HR, _default$2 as it_IT, _default$6 as ja_JP, _default$8 as ko_KR, _default$a as pl_PL, provideYunzai, _default$5 as sl_SI, stepPreloader, _default$b as tr_TR, _default$1 as vi_VI, yn, yunzaiI18nCanActivate, yunzaiI18nCanActivateChild, _default$d as zh_CN, _default$c as zh_TW };
export type { ApiConfig, App, DrawerHelperOptions, Environment, ExceptionLocaleData, FullLocaleData, HttpObserve, HttpOptions, LangConfigData, Layout, LocaleData, METHOD_TYPE, Menu, MenuIcon, MenuInner, MiniProgressLocaleData, ModalHelperDragOptions, ModalHelperOptions, NoticeIconLocaleData, OnboardingLocaleData, REP_TYPE, ReuseTabLocaleData, RouteTitle, SFErrorLocaleData, SFLocaleData, STLocaleData, SettingsKeys, SettingsNotify, TagSelectLocaleData, User, YNMode, YNOptions, YunzaiI18NService, YunzaiI18NType, YunzaiProvideLang, YunzaiProvideOptions, _HttpHeaders };
