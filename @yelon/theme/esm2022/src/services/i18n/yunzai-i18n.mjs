...
export class YunzaiHttpI18NService extends YunzaiI18nBaseService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.0", ngImport: i0, type: YunzaiHttpI18NService, deps: [{ token: i1._HttpClient }, { token: i2.SettingsService }, { token: i3.NzI18nService }, { token: i4.YelonLocaleService }, { token: i5.Platform }, { token: YA_SERVICE_TOKEN }, { token: i6.YunzaiConfigService }], target: i0.ɵɵFactoryTarget.Injectable }); }
