...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('date-fns'), require('@yelon/chart/core'), require('@yelon/util/date-time'), require('@yelon/util/decorator'), require('@angular/common'), require('ng-zorro-antd/core/outlet'), require('ng-zorro-antd/skeleton')) :
    typeof define === 'function' && define.amd ? define('@yelon/chart/timeline', ['exports', '@angular/core', 'date-fns', '@yelon/chart/core', '@yelon/util/date-time', '@yelon/util/decorator', '@angular/common', 'ng-zorro-antd/core/outlet', 'ng-zorro-antd/skeleton'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.yelon = global.yelon || {}, global.yelon.chart = global.yelon.chart || {}, global.yelon.chart.timeline = {}), global.ng.core, global.dateFns, global.yelon.chart.core, global.dateTime, global.decorator, global.ng.common, global["ng-zorro-antd/core/outlet"], global.skeleton));
