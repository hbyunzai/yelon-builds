...
class YunzaiTableUserModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.0", ngImport: i0, type: YunzaiTableUserModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "18.2.0", ngImport: i0, type: YunzaiTableUserModule, imports: [CommonModule,
            YelonFormModule,
            STModule,
            I18nPipe,
            NzCheckboxModule,
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "18.2.0", ngImport: i0, type: YunzaiTableUserModule, providers: [YunzaiTableUserService], imports: [CommonModule,
            YelonFormModule,
            STModule,
            NzCheckboxModule,
            NzDividerModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.0", ngImport: i0, type: YunzaiTableUserModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
