...
const YUNZAI_SHARED_YELON_MODULES = [
    YunzaiThemeModule,
    NoticeIconModule,
    ReuseTabModule,
    LayoutDefaultModule,
...
export { YUNZAI_SHARED_YELON_MODULES, YunzaiSharedYelonModule };
//# sourceMappingURL=yunzai-shared-yelon.mjs.map
