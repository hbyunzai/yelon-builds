...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('date-fns'), require('@yelon/util/config'), require('@angular/cdk/platform')) :
    typeof define === 'function' && define.amd ? define('@yelon/cache', ['exports', '@angular/common/http', '@angular/core', 'rxjs', 'rxjs/operators', 'date-fns', '@yelon/util/config', '@angular/cdk/platform'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.yelon = global.yelon || {}, global.yelon.cache = {}), global.ng.common.http, global.ng.core, global.rxjs, global.rxjs.operators, global.dateFns, global.i1, global.ng.cdk.platform));
    ...
    CacheService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function CacheService_Factory() { return new CacheService(i0__namespace.ɵɵinject(i1__namespace.YunzaiConfigService), i0__namespace.ɵɵinject(DC_STORE_STORAGE_TOKEN), i0__namespace.ɵɵinject(i3__namespace.HttpClient)); }, token: CacheService, providedIn: "root" });
    ...
    var YelonCacheModule = /** @class */ (function () {
        function YelonCacheModule() {
        }
        return YelonCacheModule;
    }());
    YelonCacheModule.decorators = [
    ...
    exports.YelonCacheModule = YelonCacheModule;
