...
export declare abstract class FormProperty {
    ...
    path: string;
    propertyId?: string;
    constructor(schemaValidatorFactory: SchemaValidatorFactory, schema: SFSchema, ui: SFUISchema | SFUISchemaItem, formData: Record<string, unknown>, parent: PropertyGroup | null, path: string, _options: YunzaiSFConfig);
