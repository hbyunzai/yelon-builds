...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: SFComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: FormPropertyFactory }, { type: TerminatorService }, { type: i3$1.DomSanitizer }, { type: i0.ChangeDetectorRef }, { type: i4.YelonLocaleService }, { type: i5.ACLService, decorators: [{
                    type: Optional
