...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.3", ngImport: i0, type: AjvSchemaValidatorFactory, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: i6.YunzaiConfigService, decorators: [{
                    type: Inject,
...
SFItemComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.3", type: SFItemComponent, selector: "sf-item", inputs: { formProperty: "formProperty" }, host: { properties: { "class.sf__item": "true" } }, viewQueries: [{ propertyName: "container", first: true, predicate: ["target"], descendants: true, read: ViewContainerRef, static: true }], exportAs: ["sfItem"], usesOnChanges: true, ngImport: i0, template: ` <ng-template #target></ng-template> `, isInline: true, encapsulation: i0.ViewEncapsulation.None });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.3", ngImport: i0, type: SFComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: FormPropertyFactory }, { type: TerminatorService }, { type: i3.DomSanitizer }, { type: i0.ChangeDetectorRef }, { type: i4.YelonLocaleService }, { type: i5.ACLService, decorators: [{
                    type: Optional
