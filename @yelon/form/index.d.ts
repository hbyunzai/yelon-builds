import { YunzaiSFConfig, YunzaiConfigService } from '@yelon/util/config';
...
import { NzSizeLDSType, NzSizeDSType, NgClassType, NzSafeAny, NgStyleInterface } from 'ng-zorro-antd/core/types';
import Ajv from 'ajv';
...
declare const SF_DEFAULT_CONFIG: YunzaiSFConfig;
declare function mergeConfig(srv: YunzaiConfigService): YunzaiSFConfig;
...
interface SFSchema {
     ...
     * ```json
     * [
     *   { "name": "yunzai-bot1", "age": 18 },
     *   { "name": "yunzai-bot2", "age": 16 }
     * ]
     * ```
     */
    items?: SFSchema;
...
declare class ArrayProperty extends PropertyGroup {
    ...
    constructor(injector: Injector, formPropertyFactory: FormPropertyFactory, schemaValidatorFactory: SchemaValidatorFactory, schema: SFSchema, ui: SFUISchema | SFUISchemaItem, formData: Record<string, unknown>, parent: PropertyGroup | null, path: string, options: YunzaiSFConfig);
...
declare abstract class FormProperty {
    ...
    path: string;
    propertyId?: string;
    constructor(injector: Injector, schemaValidatorFactory: SchemaValidatorFactory, schema: SFSchema, ui: SFUISchema | SFUISchemaItem, formData: Record<string, unknown>, parent: PropertyGroup | null, path: string, _options: YunzaiSFConfig);
...
type SFVisibleIf = Record<string, any[] | ((value: SFValue, property: FormProperty) => boolean | SFVisibleIfReturn | null)>;
/** 指定如何渲染 `Schema` */
...
declare function useFactory(injector: Injector, schemaValidatorFactory: SchemaValidatorFactory, cogSrv: YunzaiConfigService): FormPropertyFactory;
