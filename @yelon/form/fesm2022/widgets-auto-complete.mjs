...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: AutoCompleteWidget, decorators: [{
            type: Component,
            args: [{
...
class AutoCompleteWidgetModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: AutoCompleteWidgetModule, deps: [{ token: i1$1.WidgetRegistry }], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.3", ngImport: i0, type: AutoCompleteWidgetModule, imports: [FormsModule, YelonFormModule, CommonModule, NzInputModule, NzAutocompleteModule, AutoCompleteWidget] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: AutoCompleteWidgetModule, imports: [FormsModule, YelonFormModule, CommonModule, NzInputModule, NzAutocompleteModule, AutoCompleteWidget] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: AutoCompleteWidgetModule, decorators: [{
            type: NgModule,
            args: [{
