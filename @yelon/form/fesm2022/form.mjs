...
class SFComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.11", ngImport: i0, type: SFComponent, deps: [{ token: i1$1.YunzaiConfigService }], target: i0.ɵɵFactoryTarget.Component }); }
