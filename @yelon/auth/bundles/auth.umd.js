...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@yelon/util/config'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@yelon/auth', ['exports', '@angular/common', '@angular/core', '@angular/router', 'rxjs', 'rxjs/operators', '@yelon/util/config', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.yelon = global.yelon || {}, global.yelon.auth = {}), global.ng.common, global.ng.core, global.ng.router, global.rxjs, global.rxjs.operators, global.config, global.ng.common.http));
    ...
    var YA_STORE_TOKEN = new i0.InjectionToken('AUTH_STORE_TOKEN', {
        providedIn: 'root',
        factory: YA_STORE_TOKEN_LOCAL_FACTORY
    });

    function YA_SERVICE_TOKEN_FACTORY() {
        return new TokenService(i0.inject(config.YunzaiConfigService), i0.inject(YA_STORE_TOKEN));
    }
    /**
    ...
    TokenService.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: i0.Inject, args: [YA_STORE_TOKEN,] }] }
    ]; };

    var YA_SERVICE_TOKEN = new i0.InjectionToken('YA_SERVICE_TOKEN', {
        providedIn: 'root',
        factory: YA_SERVICE_TOKEN_FACTORY
    });

    var OPENTYPE = '_yelonAuthSocialType';
    var HREFCALLBACK = '_yelonAuthSocialCallbackByHref';
    ...
    SocialService.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: i0.Inject, args: [YA_SERVICE_TOKEN,] }] },
    ...
    ***************************************************************************** */
    ...
    function ToLogin(options, injector, url) {
        ...
        injector.get(YA_SERVICE_TOKEN).referrer.url = url || router$1.url;
    ...
    var BaseInterceptor = /** @class */ (function () {
        ...
        BaseInterceptor.prototype.intercept = function (req, next) {
            var e_1, _a;
            var options = mergeConfig(this.injector.get(config.YunzaiConfigService));
    ...
    JWTGuard.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function JWTGuard_Factory() { return new JWTGuard(i0__namespace.ɵɵinject(YA_SERVICE_TOKEN), i0__namespace.ɵɵinject(i0__namespace.INJECTOR)); }, token: JWTGuard, providedIn: "root" });
    JWTGuard.decorators = [
    ...
    SimpleGuard.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function SimpleGuard_Factory() { return new SimpleGuard(i0__namespace.ɵɵinject(YA_SERVICE_TOKEN), i0__namespace.ɵɵinject(i0__namespace.INJECTOR)); }, token: SimpleGuard, providedIn: "root" });
    ...
    var YelonAuthModule = /** @class */ (function () {
        function YelonAuthModule() {
        }
        return YelonAuthModule;
    }());
    YelonAuthModule.decorators = [
    ...
    exports.YA_SERVICE_TOKEN = YA_SERVICE_TOKEN;
    exports.YA_SERVICE_TOKEN_FACTORY = YA_SERVICE_TOKEN_FACTORY;
    exports.YA_STORE_TOKEN = YA_STORE_TOKEN;
    exports.YA_STORE_TOKEN_LOCAL_FACTORY = YA_STORE_TOKEN_LOCAL_FACTORY;
    exports.YelonAuthModule = YelonAuthModule;
