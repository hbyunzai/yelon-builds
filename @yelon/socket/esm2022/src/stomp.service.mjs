...
export class StompService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.1", ngImport: i0, type: StompService, deps: [{ token: i1.YunzaiConfigService }, { token: i0.Injector }, { token: i2.NotificationService }, { token: WINDOW }], target: i0.ɵɵFactoryTarget.Injectable }); }
