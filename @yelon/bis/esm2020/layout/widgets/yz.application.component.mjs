...
YzHeaderApplicationComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.3", ngImport: i0, type: YzHeaderApplicationComponent, deps: [{ token: i0.Injector }, { token: i1.CacheService }, { token: i2.YzI18NService }, { token: i3._HttpClient }], target: i0.ɵɵFactoryTarget.Component });
