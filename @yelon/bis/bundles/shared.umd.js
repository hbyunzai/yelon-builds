    ...
    ***************************************************************************** */
    ...
    YzSharedModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: __spreadArray(__spreadArray([], __read(YZ_SHARED_YELON_MODULES)), __read(YZ_SHARED_ZORRO_MODULES)),
                    exports: __spreadArray(__spreadArray([], __read(YZ_SHARED_YELON_MODULES)), __read(YZ_SHARED_ZORRO_MODULES))
                },] }
    ];
