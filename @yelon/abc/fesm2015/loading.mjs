...
LoadingService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.3", ngImport: i0, type: LoadingService, deps: [{ token: i1$1.Overlay }, { token: i2$1.YunzaiConfigService }, { token: i3$1.Directionality, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.3", ngImport: i0, type: LoadingService, decorators: [{
        ...
        return [{ type: i1$1.Overlay }, { type: i2$1.YunzaiConfigService }, { type: i3$1.Directionality, decorators: [{
                        type: Optional
                    }] }];
    } });
