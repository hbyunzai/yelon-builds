...
export declare class OnboardingService implements OnDestroy {
     ...
     */
    get running(): boolean;
    constructor(i18n: YelonLocaleService, appRef: ApplicationRef, router: Router, doc: NzSafeAny, configSrv: YunzaiConfigService, keyStoreSrv: OnBoardingKeyStore, directionality: Directionality);
    private attach;
