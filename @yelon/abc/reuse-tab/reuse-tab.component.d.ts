...
export declare class ReuseTabComponent implements OnInit, OnChanges {
    ...
    constructor(srv: ReuseTabService, cdr: ChangeDetectorRef, router: Router, route: ActivatedRoute, i18nSrv: YunzaiI18NService, doc: NzSafeAny, platform: Platform, directionality: Directionality, stateKey: string, stateSrv: ReuseTabStorageState);
    private genTit;
    private get curUrl();
    private genCurItem;
    private genList;
