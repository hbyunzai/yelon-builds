...
class NoticeIconComponent {
    locale = toSignal(inject(YelonLocaleService).change.pipe(map(data => data['noticeIcon'])), {
        requireSync: true
    });
    data = input([]);
...
class NoticeIconModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.7", ngImport: i0, type: NoticeIconModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.2.7", ngImport: i0, type: NoticeIconModule, imports: [CommonModule,
            YelonLocaleModule,
            NzBadgeModule,
            NzDropDownModule,
            NzIconModule,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.2.7", ngImport: i0, type: NoticeIconModule, imports: [CommonModule,
            YelonLocaleModule,
            NzBadgeModule,
            NzDropDownModule,
            NzIconModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.7", ngImport: i0, type: NoticeIconModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
