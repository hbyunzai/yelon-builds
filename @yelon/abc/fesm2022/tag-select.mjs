...
class TagSelectComponent {
    locale = inject(YelonLocaleService).valueSignal('tagSelect');
    expand = false;
...
class TagSelectModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: TagSelectModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.3", ngImport: i0, type: TagSelectModule, imports: [CommonModule, NzIconModule, YelonLocaleModule, TagSelectComponent], exports: [TagSelectComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: TagSelectModule, imports: [CommonModule, NzIconModule, YelonLocaleModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: i0, type: TagSelectModule, decorators: [{
            type: NgModule,
            args: [{
