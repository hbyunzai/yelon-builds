...
export interface STColumn<T extends STData = any> {
     ...
     * - `yn` 将`boolean`类型徽章化 [document](https://ng.yunzainfo/docs/data-render#yn)
     * - `cell` 使用 `cell` 组件渲染 [document](https://ng.yunzainfo/components/cell)
     * - `widget` 使用自定义小部件动态创建
     */
    ...
    /**
     * Safe rendering type, default: `safeHtml`, Support [global config](https://ng.yunzainfo/docs/global-config)
     *
     * 安全渲染方式，默认：`safeHtml`，支持[全局配置](https://ng.yunzainfo/docs/global-config/zh)
     */
    ...
    dateFormat?: string;
    /**
     * Currency format option, `type=currency` is valid, pls refer of [CurrencyService.commas](https://ng.yunzainfo/util/format/#commas).
     *
    ...
    exported?: boolean;
    /**
     * 权限，等同 [ACLCanType](https://ng.yunzainfo/acl/getting-started/#ACLCanType) 参数值
     */
    acl?: ACLCanType;
    /** 当不存在数据时以默认值替代 */
    default?: string;
...
export interface STColumnFilter<T extends STData = any> {
    ...
    /**
     * 自定义过滤器，请参考 [Custom Data](https://ng.yunzainfo/components/st/en?#components-st-custom-data) 示例。
     */
    custom?: TemplateRef<{
...
export interface STcolumnCurrency {
    /**
     * See [CurrencyService.commas](https://ng.yunzainfo/util/format/en#format)
     */
