...
import { CellOptions } from '@yelon/abc/cell';
import { ACLCanType } from '@yelon/acl';
import * as _yelon_theme from '@yelon/theme';
import { ModalHelperOptions, DrawerHelperOptions, YNMode, _HttpClient, DatePipe, YNPipe } from '@yelon/theme';
...
declare class STComponent implements AfterViewInit, OnChanges {
    ...
    _widthConfig: string[];
    locale: i0.Signal<_yelon_theme.STLocaleData>;
    _loading: boolean;
    _data: STData[];
...
declare const ST_DEFAULT_CONFIG: YunzaiSTConfig;
