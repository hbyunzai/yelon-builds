...
export declare class PageHeaderComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    constructor(settings: SettingsService, renderer: Renderer2, router: Router, menuSrv: MenuService, i18nSrv: YunzaiI18NService, titleSrv: TitleService, reuseSrv: ReuseTabService, cdr: ChangeDetectorRef, configSrv: YunzaiConfigService, platform: Platform, directionality: Directionality);
    refresh(): void;
