...
export declare class PdfComponent implements OnChanges, AfterViewInit, OnDestroy {
    ...
    private get win();
    private get el();
    constructor(ngZone: NgZone, configSrv: YunzaiConfigService, lazySrv: LazyService, platform: Platform, _el: ElementRef<HTMLElement>, doc: NzSafeAny, cdr: ChangeDetectorRef);
    private getValidPi;
    private emit;
    private initDelay;
