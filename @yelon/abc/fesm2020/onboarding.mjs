...
OnboardingService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: OnboardingService, deps: [{ token: i1$1.YelonLocaleService }, { token: i0.ApplicationRef }, { token: i0.ComponentFactoryResolver }, { token: i2$1.Router }, { token: i0.Injector }, { token: DOCUMENT }, { token: i3$1.YunzaiConfigService }, { token: i4$1.Directionality, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: OnboardingService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.YelonLocaleService }, { type: i0.ApplicationRef }, { type: i0.ComponentFactoryResolver }, { type: i2$1.Router }, { type: i0.Injector }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT]
                }] }, { type: i3$1.YunzaiConfigService }, { type: i4$1.Directionality, decorators: [{
                    type: Optional
                }] }]; } });
