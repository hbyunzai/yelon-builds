...
(function (global, factory) {
    ...
    OnboardingService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function OnboardingService_Factory() { return new OnboardingService(i0__namespace.ɵɵinject(i1__namespace.YelonLocaleService), i0__namespace.ɵɵinject(i0__namespace.ApplicationRef), i0__namespace.ɵɵinject(i0__namespace.ComponentFactoryResolver), i0__namespace.ɵɵinject(i2__namespace.Router), i0__namespace.ɵɵinject(i0__namespace.INJECTOR), i0__namespace.ɵɵinject(i3__namespace.DOCUMENT), i0__namespace.ɵɵinject(i4__namespace.YunzaiConfigService), i0__namespace.ɵɵinject(i5__namespace.Directionality, 8)); }, token: OnboardingService, providedIn: "root" });
    ...
    OnboardingModule.decorators = [
        { type: i0.NgModule, args: [{
                    imports: [i3.CommonModule, i1.YelonLocaleModule, popover.NzPopoverModule, outlet.NzOutletModule, button.NzButtonModule, noAnimation.NzNoAnimationModule],
