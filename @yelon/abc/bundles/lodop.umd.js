...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@yelon/util/config'), require('@yelon/util/other')) :
    typeof define === 'function' && define.amd ? define('@yelon/abc/lodop', ['exports', '@angular/core', 'rxjs', '@yelon/util/config', '@yelon/util/other'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.yelon = global.yelon || {}, global.yelon.abc = global.yelon.abc || {}, global.yelon.abc.lodop = {}), global.ng.core, global.rxjs, global.i2, global.i1));
    ...
    ***************************************************************************** */
    ...
    LodopService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function LodopService_Factory() { return new LodopService(i0__namespace.ɵɵinject(i1__namespace.LazyService), i0__namespace.ɵɵinject(i2__namespace.YunzaiConfigService)); }, token: LodopService, providedIn: "root" });
