...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/bidi'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@yelon/theme'), require('@yelon/util/decorator'), require('@angular/common'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('@yelon/abc/tag-select', ['exports', '@angular/cdk/bidi', '@angular/core', 'rxjs', 'rxjs/operators', '@yelon/theme', '@yelon/util/decorator', '@angular/common', 'ng-zorro-antd/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.yelon = global.yelon || {}, global.yelon.abc = global.yelon.abc || {}, global.yelon.abc["tag-select"] = {}), global.ng.cdk.bidi, global.ng.core, global.rxjs, global.rxjs.operators, global.yelon.theme, global.decorator, global.ng.common, global["ng-zorro-antd/icon"]));
    ...
    ***************************************************************************** */
    ...
    TagSelectModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [common.CommonModule, icon.NzIconModule, theme.YelonLocaleModule],
