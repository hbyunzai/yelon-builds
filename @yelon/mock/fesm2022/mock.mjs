...
class MockService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: MockService, deps: [{ token: i1.YunzaiConfigService }, { token: MockOptions }], target: i0.ɵɵFactoryTarget.Injectable }); }
