...
const YELON_MOCK_CONFIG = new InjectionToken('yunzai-mock-config');
...
class MockService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.6", ngImport: i0, type: MockService, deps: [{ token: i1.YunzaiConfigService }, { token: YELON_MOCK_CONFIG, optional: true }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "18.2.6", ngImport: i0, type: MockService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.6", ngImport: i0, type: MockService, decorators: [{
            type: Injectable,
...
export { MockService, MockStatusError, YELON_MOCK_CONFIG, delay, mockInterceptor, provideMockConfig, r };
