...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@yelon/util/config'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('@yelon/util/other')) :
    typeof define === 'function' && define.amd ? define('@yelon/mock', ['exports', '@angular/core', '@yelon/util/config', '@angular/common/http', 'rxjs', 'rxjs/operators', '@yelon/util/other'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.yelon = global.yelon || {}, global.yelon.mock = {}), global.ng.core, global.i1, global.ng.common.http, global.rxjs, global.rxjs.operators, global.other));
    ...
    MockService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function MockService_Factory() { return new MockService(i0__namespace.ɵɵinject(i1__namespace.YunzaiConfigService), i0__namespace.ɵɵinject(MockOptions)); }, token: MockService, providedIn: "root" });
    ...
    var YelonMockModule = /** @class */ (function () {
        function YelonMockModule() {
        }
        YelonMockModule.forRoot = function (options) {
            return {
        ...
        YelonMockModule.forChild = function () {
            return {
                ngModule: YelonMockModule,
                providers: [{ provide: http.HTTP_INTERCEPTORS, useClass: MockInterceptor, multi: true }]
            };
        };
        return YelonMockModule;
    }());
    YelonMockModule.decorators = [
    ...
    exports.YelonMockModule = YelonMockModule;
